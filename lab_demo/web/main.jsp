            ...
            <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#Booking-Div" data-toggle="tab" id="Booking-Tab">Booking</a>                         
                        <a class="navbar-brand" href="#ViewBooking-Div" data-toggle="tab" id="Viewboooking-Tab">Booking List</a>
                    </div>
                    <ul class="nav navbar-nav navbar-right">                            
                        <li><a href="logout.jsp" id="Logout-Tab" ><span style="color:#70bd24; font-size: 14px;">You are logging in as: <%=log%></span>&emsp;<span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
                            <%} else {%>
                        <li><a href="logout.jsp" id="Logout-Tab" ><span style="color:#70bd24">No Existing User!</span>&emsp;<span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
                            <%}%>
                    </ul> 
                </div>
            </nav>           
